...
document.getElementById("searchByEspecialidad").addEventListener("click", function (){
    getParams("especialidadParam", "especialidad");
});
...
function getId(event)
{
    ...
    document.getElementById("deleteModalbtn").addEventListener("click", function() {
           window.location.href = "Acciones?action=deleteMedico&id="+id; 
    });
}
...
function getParams(idElement, column)
{
    ...
    window.location.href = "Acciones?action=searchMedico&param="+param+"&column="+column;
}
