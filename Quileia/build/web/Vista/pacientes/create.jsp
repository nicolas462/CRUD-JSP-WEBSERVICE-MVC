...
<html>
    ...
    <body>
        ...
        <div class ="container">
            <div class="row head">
                <div class="col"><h3>Añadir Paciente</h3></div>
            </div>
            <hr>
            <!-- form -->
            <form class="row g-3 needs-validation" novalidate>
                <div class="col-md-7">
                    ...
                    <input type="text" class="form-control" name="nombrePaciente" value="" placeholder="Nombres y Apellidos" required>
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" class="form-control" name="identificacionPaciente" placeholder="51955221" value="" required>
                    <div class="invalid-feedback">
                ...
                <div class="col-md-3">
                    ...
                    <input type="date" class="form-control" name="fechaNacimientoPaciente" value="" required>
                    <div class="invalid-feedback">
                ...
                <div class="col-md-9">
                    ...
                    <input type="text" class="form-control" name="epsPaciente" placeholder="Nueva EPS, Colsanitas, ..." value="" required>
                    <div class="invalid-feedback">
                ...
                <div class="col-12 text-center">
                    <input class="btn btn-primary" type="submit" name="action" value="Agregar Paciente" text>
                </div>
            </form>
            <!-- end form -->
        </div>
